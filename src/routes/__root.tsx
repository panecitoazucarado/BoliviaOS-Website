...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "/assets/boliviaos-symbol.png" },
      { property: "og:image:alt", content: "Logotipo oficial de BoliviaOS para PlayStation 2" },
      ...
      { name: "twitter:image", content: "/assets/boliviaos-symbol.png" },
